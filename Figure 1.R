...
cces1 <- data.frame(survey = c("CCES 2008", "CCES 2008", "CCES 2012", "CCES 2012", "CCES 2016", "CCES 2016"),
                    sample = c("Affiliation", "Self ID", "Affiliation", "Self ID", "Affiliation", "Self ID"),
...
gss1 <- data.frame(survey = c("GSS 2010", "GSS 2010", "GSS 2012", "GSS 2012", "GSS 2014", "GSS 2014", "GSS 2016", "GSS 2016"),
                   sample = c("Affiliation", "Self ID", "Affiliation", "Self ID", "Affiliation", "Self ID", "Affiliation", "Self ID"),
...
ggsave(file="freq_with_weights_final.png", type = "cairo-png", width = 12, height = 12)
